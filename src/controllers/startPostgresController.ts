...
const startPostgresController=async({params,set,userId}:Context | any)=>{
  ...
  try {
    ...
    await ssh.runSequential(startPostgres)
  } catch (error) {
...
export default startPostgresController